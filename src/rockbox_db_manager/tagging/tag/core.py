...
class Tag:
    ...
    @classmethod
    def RegisterKey(cls, name: str, type: Any = 'default',
    ...
    @classmethod
    def RegisterInfoKey(cls, key: str, name: str, type: Any = 'default',
                        convert: Optional[Callable] = None):
        def getter(tags):
    ...
    @classmethod
    def RegisterBasicKey(cls, key: str, name: str, type: Any = 'default',
                         convert: Optional[Callable] = None):
        def getter(tags):
            return tags[name]
    ...
    def RegisterUserKey(cls, name_func: Callable, type: Any = 'default'):
        ...
        cls.RegisterKey('user_field', type, user_field_getter,
                        user_field_setter, user_field_deleter, conv_string_list)
